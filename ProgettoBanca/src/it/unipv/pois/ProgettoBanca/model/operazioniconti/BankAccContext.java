...
public class BankAccContext {
	...
	public BankAccContext(Conto c, double cifra, String scelta) {
		super();
		this.c = c;
		this.cifra = cifra;
		this.scelta = scelta;
	...
	public BankAccContext(Conto c, String psw, double cifra, String scelta) {
		super();
		this.c = c;
		this.psw = psw;
		this.cifra = cifra;
